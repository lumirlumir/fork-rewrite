...
## [0.24.0](https://github.com/lumirlumir/fork-rewrite/compare/config-array-v0.23.1...config-array-v0.24.0) (2026-02-15)
...
* The following workspace dependencies were updated
  * dependencies
    * @eslint/object-schema bumped from ^3.0.1 to ^4.0.0
