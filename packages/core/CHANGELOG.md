...
## [2.0.0](https://github.com/lumirlumir/fork-rewrite/compare/core-v1.2.1...core-v2.0.0) (2026-05-07)


### ⚠ BREAKING CHANGES

* Remove deprecated RuleContext methods ([#263](https://github.com/lumirlumir/fork-rewrite/issues/263))
* remove deprecated `nodeType` property ([#265](https://github.com/lumirlumir/fork-rewrite/issues/265))
...
* add `languages` and `docs.dialects` to rule `meta` types ([#421](https://github.com/lumirlumir/fork-rewrite/issues/421)) ([7680f69](https://github.com/lumirlumir/fork-rewrite/commit/7680f692119a094abb1c8317aba713168563c07c))
...
* Add custom rule type helpers to `@eslint/plugin-kit` ([#355](https://github.com/lumirlumir/fork-rewrite/issues/355)) ([8ac8530](https://github.com/lumirlumir/fork-rewrite/commit/8ac853046aa1d4288d06d639be234c09988ade5e))
...
* Add extendable config types ([#210](https://github.com/lumirlumir/fork-rewrite/issues/210)) ([3089754](https://github.com/lumirlumir/fork-rewrite/commit/3089754848c1acd30368424271810cc9703a6cd4))
...
* export additional core types ([#304](https://github.com/lumirlumir/fork-rewrite/issues/304)) ([5ccde5b](https://github.com/lumirlumir/fork-rewrite/commit/5ccde5bc9442c572d740c063fcb50392bf13c3db))
...
* Allow RuleConfig to have array with just severity ([#228](https://github.com/lumirlumir/fork-rewrite/issues/228)) ([c5f92fa](https://github.com/lumirlumir/fork-rewrite/commit/c5f92fa147ecad74164266c374f47ee217c7ccb7))
* make `data` property stricter ([#327](https://github.com/lumirlumir/fork-rewrite/issues/327)) ([26e6a50](https://github.com/lumirlumir/fork-rewrite/commit/26e6a50b85bb07b24244095e38e649f746508765))
...
* remove `category` property from `RulesMetaDocs` interface ([#345](https://github.com/lumirlumir/fork-rewrite/issues/345)) ([b197f00](https://github.com/lumirlumir/fork-rewrite/commit/b197f00f30f96fce72aca4537c2863eaefd83d43))
* remove `experimentalObjectRestSpread` option from types ([#343](https://github.com/lumirlumir/fork-rewrite/issues/343)) ([e3533bc](https://github.com/lumirlumir/fork-rewrite/commit/e3533bcf06a9bc36502fff260f827a289b9c2059))
* remove deprecated `nodeType` property ([#265](https://github.com/lumirlumir/fork-rewrite/issues/265)) ([7d6a2a8](https://github.com/lumirlumir/fork-rewrite/commit/7d6a2a8dfb73203790403dea240669b6ab543340))
* Remove deprecated RuleContext methods ([#263](https://github.com/lumirlumir/fork-rewrite/issues/263)) ([0455323](https://github.com/lumirlumir/fork-rewrite/commit/0455323682227ba2e219645a49c20085ab76cbf0))
* remove unsupported `nodeType` from types ([#268](https://github.com/lumirlumir/fork-rewrite/issues/268)) ([d800559](https://github.com/lumirlumir/fork-rewrite/commit/d8005593158f55ba32f5279f3385db95ab87075a))
* require `fix` in suggestion objects ([#298](https://github.com/lumirlumir/fork-rewrite/issues/298)) ([02bac50](https://github.com/lumirlumir/fork-rewrite/commit/02bac50b8a053f12a97afbe65b126ccd2c469d9e))
...
* type-check defaultLanguageOptions against LangOptions ([#420](https://github.com/lumirlumir/fork-rewrite/issues/420)) ([7bf5704](https://github.com/lumirlumir/fork-rewrite/commit/7bf57046b8df02855dde132dc970f89cd5f8437e))
* type-check suggestion messageId against MessageIds ([#392](https://github.com/lumirlumir/fork-rewrite/issues/392)) ([76c2196](https://github.com/lumirlumir/fork-rewrite/commit/76c2196107d361661907a29e31b6032dd2d044f2))
